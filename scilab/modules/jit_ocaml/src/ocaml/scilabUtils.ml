...
and is_equal_vardec vd1 vd2 =
  let str1 = ScilabContext.symbol_name vd1.varDec_name and
      str2 = ScilabContext.symbol_name vd2.varDec_name in
  if str1 <> str2
...
and is_equal_dec dec1 dec2 = match dec1, dec2 with
  | FunctionDec dec1, FunctionDec dec2 ->
      ...
      let fname1 = ScilabContext.symbol_name dec1.functionDec_symbol and
          fname2 = ScilabContext.symbol_name dec2.functionDec_symbol in
      if fname1 <> fname2
